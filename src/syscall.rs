...
pub const SYSCALL_THREAD_CREATE: usize = 420;
pub const SYSCALL_GETTID: usize = 421;
pub const SYSCALL_WAITTID: usize = 422;
pub const SYSCALL_MUTEX_CREATE: usize = 430;
pub const SYSCALL_MUTEX_LOCK: usize = 431;
pub const SYSCALL_MUTEX_UNLOCK: usize = 432;
pub const SYSCALL_SEMAPHORE_CREATE: usize = 440;
pub const SYSCALL_SEMAPHORE_UP: usize = 441;
pub const SYSCALL_SEMAPHORE_DOWN: usize = 442;
pub const SYSCALL_CONDVAR_CREATE: usize = 450;
pub const SYSCALL_CONDVAR_SIGNAL: usize = 451;
pub const SYSCALL_CONDVAR_WAIT: usize = 452;
